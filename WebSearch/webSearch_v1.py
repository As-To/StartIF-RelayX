...
# ----------------------------
# Recherche  : ce n'est pas un agent autonome complet, mais une boucle de recherche + scoring + filtrage
# ----------------------------
...
def export_to_csv(results, output_file="websearch_results_v1.csv"):
    fieldnames = [
        "ingredient",
        "query",
        "title",
